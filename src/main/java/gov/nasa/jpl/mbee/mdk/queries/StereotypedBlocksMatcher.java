...
public class StereotypedBlocksMatcher extends BaseMatcher<StereotypedBlocksMatch> {
   ...
   * 
   */
  public static StereotypedBlocksMatcher on(final ViatraQueryEngine engine) {
   ...
   * 
   */
  public static StereotypedBlocksMatcher create() {
   ...
   * 
   */
  private StereotypedBlocksMatcher() {
   ...
   * 
   */
  public static IQuerySpecification<StereotypedBlocksMatcher> querySpecification() {
