...
public final class GeneralizationQuerySpecification extends BaseGeneratedEMFQuerySpecification<GeneralizationMatcher> {
   ...
   * 
   */
  public static GeneralizationQuerySpecification instance() {
    try{
  ...
  @Override
  protected GeneralizationMatcher instantiate(final ViatraQueryEngine engine) {
    return GeneralizationMatcher.on(engine);
  }
  
  @Override
  public GeneralizationMatcher instantiate() {
