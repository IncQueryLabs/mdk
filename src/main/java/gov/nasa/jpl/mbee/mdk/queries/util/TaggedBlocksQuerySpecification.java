...
public final class TaggedBlocksQuerySpecification extends BaseGeneratedEMFQuerySpecification<TaggedBlocksMatcher> {
   ...
   * 
   */
  public static TaggedBlocksQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TaggedBlocksMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TaggedBlocksMatcher.on(engine);
  }
  
  @Override
  public TaggedBlocksMatcher instantiate() throws ViatraQueryException {
  ...
  /**
   * Inner class allowing the singleton instance of {@link TaggedBlocksQuerySpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TaggedBlocksQuerySpecification#instance()}.
   * 
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var_value), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5", "LiteralSpecification")));
              ...
              //  // Slot value	find stereotypes(stereotype, property)
