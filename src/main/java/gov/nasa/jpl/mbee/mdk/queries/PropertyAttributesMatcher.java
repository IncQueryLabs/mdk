...
public class PropertyAttributesMatcher extends BaseMatcher<PropertyAttributesMatch> {
   ...
   * 
   */
  public static PropertyAttributesMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
   ...
   * 
   */
  public static PropertyAttributesMatcher create() throws ViatraQueryException {
   ...
   * 
   */
  private PropertyAttributesMatcher() throws ViatraQueryException {
   ...
   * 
   */
  public static IQuerySpecification<PropertyAttributesMatcher> querySpecification() throws ViatraQueryException {
