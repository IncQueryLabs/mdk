...
/**
 * Generated pattern matcher API of the gov.nasa.jpl.mbee.mdk.queries.DependencyChain pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link DependencyChainMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see DependencyChainQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class DependencyChainMatcher extends BaseMatcher<DependencyChainMatch> {
  /**
   ...
   * 
   */
  public static DependencyChainMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
   ...
   * 
   */
  public static DependencyChainMatcher create() throws ViatraQueryException {
    return new DependencyChainMatcher();
  }
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DependencyChainMatcher.class);
   ...
   * 
   */
  private DependencyChainMatcher() throws ViatraQueryException {
   ...
   * @return matches represented as a DependencyChainMatch object.
   * 
   */
  public Collection<DependencyChainMatch> getAllMatches(final Dependency pSource, final Dependency pTarget) {
   ...
   * @param pSource the fixed value of pattern parameter source, or null if not bound.
   * @param pTarget the fixed value of pattern parameter target, or null if not bound.
   * @return a match represented as a DependencyChainMatch object, or null if no match is found.
   * 
   */
  public DependencyChainMatch getOneArbitraryMatch(final Dependency pSource, final Dependency pTarget) {
   ...
   * 
   */
  public void forEachMatch(final Dependency pSource, final Dependency pTarget, final IMatchProcessor<? super DependencyChainMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Dependency pSource, final Dependency pTarget, final IMatchProcessor<? super DependencyChainMatch> processor) {
   ...
   * 
   */
  public DependencyChainMatch newMatch(final Dependency pSource, final Dependency pTarget) {
    return DependencyChainMatch.newMatch(pSource, pTarget);
  }
   ...
   * 
   */
  public static IQuerySpecification<DependencyChainMatcher> querySpecification() throws ViatraQueryException {
