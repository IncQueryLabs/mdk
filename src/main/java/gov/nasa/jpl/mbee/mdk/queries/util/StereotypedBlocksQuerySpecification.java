...
public final class StereotypedBlocksQuerySpecification extends BaseGeneratedEMFQuerySpecification<StereotypedBlocksMatcher> {
   ...
   * 
   */
  public static StereotypedBlocksQuerySpecification instance() {
    try{
  ...
  @Override
  protected StereotypedBlocksMatcher instantiate(final ViatraQueryEngine engine) {
    return StereotypedBlocksMatcher.on(engine);
  }
  
  @Override
  public StereotypedBlocksMatcher instantiate() {
