...
public final class BlocksQuerySpecification extends BaseGeneratedEMFQuerySpecification<BlocksMatcher> {
  ...
  @Override
  protected BlocksMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return BlocksMatcher.on(engine);
  }
  
  @Override
  public BlocksMatcher instantiate() throws ViatraQueryException {
    return BlocksMatcher.create();
  }
  
  @Override
  public BlocksMatch newEmptyMatch() {
    return BlocksMatch.newEmptyMatch();
  }
  
  @Override
  public BlocksMatch newMatch(final Object... parameters) {
    return BlocksMatch.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0]);
  }
