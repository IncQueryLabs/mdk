...
public final class PropertyAttributesQuerySpecification extends BaseGeneratedEMFQuerySpecification<PropertyAttributesMatcher> {
   ...
   * 
   */
  public static PropertyAttributesQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected PropertyAttributesMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return PropertyAttributesMatcher.on(engine);
  }
  
  @Override
  public PropertyAttributesMatcher instantiate() throws ViatraQueryException {
