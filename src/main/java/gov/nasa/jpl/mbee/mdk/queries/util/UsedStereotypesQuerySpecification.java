...
public final class UsedStereotypesQuerySpecification extends BaseGeneratedEMFQuerySpecification<UsedStereotypesMatcher> {
   ...
   * 
   */
  public static UsedStereotypesQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected UsedStereotypesMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return UsedStereotypesMatcher.on(engine);
  }
  
  @Override
  public UsedStereotypesMatcher instantiate() throws ViatraQueryException {
